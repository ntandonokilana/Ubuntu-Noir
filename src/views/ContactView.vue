      ...
      <div v-for="product in filteredProducts" :key="product.productID" class="product-card">
        ...
        <div class="product-details">
          ...
          <div class="product-buttons">
            ...
            <!-- Modify the anchor tag to redirect to SinglePageView.vue -->
            <router-link :to="{ name: 'SinglePageView', params: { productId: product.productID }}" class="btn btn-primary view-more-btn" data-mdb-ripple-init>View More</router-link>
          </div>
        </div>
      </div>
    </div>
